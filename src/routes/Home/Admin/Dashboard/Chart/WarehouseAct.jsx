...
const WarehouseAct = ({ incoming, outgoing }) => {
	return (
		<div className="relative rounded-xl border p-2 bg-green_dark1">
			...
			<div className="p-4">
				<span className="text-[1.125rem] font-bold text-offwhite">Warehouse Activities</span>
			</div>
			...
			<div className="mb-5 p-4">
				<div className="relative">
					...
					<div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 transform text-center">
						<p className="text-[1rem] text-offwhite">Space used</p>
						<span className="text-[2.5rem] font-bold text-offwhite">
			...
			<div className="flex justify-between px-4">
				<div className="flex space-x-1 align-middle text-green_dark1">
					...
					<div className="text-[0.875rem] text-offwhite">Incoming: {incoming}</div>
				</div>
				<div className="flex space-x-1 align-middle text-green_dark1">
					<svg
						xmlns="http://www.w3.org/2000/svg"
					...
					<div className="text-[0.875rem] text-offwhite">Outgoing: {outgoing}</div>
				</div>
			</div>

			<div className="space-y-4 p-2 text-offwhite">
				<span className="text-[1.125rem] font-bold">Inventory Snapshot</span>
				<div className="space-y-4 rounded-lg bg-[#67aa7b] px-8 py-4">
					<div className="flex justify-between text-[0.875rem] text-[#fff]">
						<span>Inventory</span>
						<div className="font-bold">1,200 products</div>
					</div>
					<div className="flex justify-between text-[0.875rem] text-[red]">
