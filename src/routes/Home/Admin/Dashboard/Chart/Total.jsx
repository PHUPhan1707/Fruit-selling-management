	  ...
	  <div className="relative h-full rounded-xl border p-2">
		...
		<div className="relative rounded-xl p-6">
		  <div className="flex justify-between space-x-4">
			{/* Revenue */}
			<div className="h-[190px] w-[22%] rounded-lg bg-green_dark1">
				...
				<div className="space-y-4">
				  <div>
					<svg
					  ...
					  viewBox="0 0 32 32"
					  fill="none"
					  className="rounded-full bg-[#FFFFFF] p-2"
				  ...
				  <div className="text-offwhite">
					<div className="text-[0.9rem]">Revenue</div>
					<span className="text-[1.2rem] font-semibold">${revenue}</span>
				  </div>
				</div>
				<div>
				  <svg
			  ...
			  <hr className="border-dashed border-white text-[#FFFFFF] border-1" />
			  <div className="px-4 py-2">
				<div className="flex items-center space-x-1">
				  <div className="flex items-center space-x-1 rounded-full border border-[#000000] bg-[#FFFFFF] px-2 py-1 text-[#A0D900]">
					<i className="fa fa-arrow-up h-3 w-3"></i>
					<span className="text-[0.65rem]">25%</span>
				  </div>
				  <div className="text-[0.65rem] text-offwhite">
					vs 7 days ago
				  </div>
				</div>
			  </div>
			...
			<div className="h-[190px] w-[22%] rounded-lg bg-green_dark1">
				...
				<div className="space-y-4">
				  <div>
					<svg
					  ...
					  viewBox="0 0 32 32"
					  fill="none"
					  className="rounded-full bg-[#F5F2FD] p-2"
				  ...
				  <div className="text-offwhite">
					<div className="text-[0.9rem]">Cost</div>
					<span className="text-[1.2rem] font-semibold">${cost}</span>
				  </div>
				</div>
				<div>
				  <svg
			  ...
			  <div className="px-4 py-2">
				<div className="flex items-center space-x-1">
				  <div className="flex items-center space-x-1 rounded-full border border-[#000000] bg-[#FFFFFF] bg-[#F0716733] px-2 py-1 text-[#F07167]">
					<i className="fa fa-arrow-down h-3 w-3"></i>
					<span className="text-[0.65rem]">15%</span>
				  </div>
				  <div className="text-[0.65rem] text-offwhite">
					vs 7 days ago
				  </div>
			...
			<div className="h-[190px] w-[22%] rounded-lg bg-green_dark1">
			  <div className="flex justify-between px-4 pb-4 pt-6">
				<div className="space-y-4">
				  ...
				  <div className="text-offwhite">
					<div className="text-[0.9rem]">Production</div>
					<span className="text-[1.2rem] font-semibold">{productionVolume}kg</span>
				  </div>
				</div>
				<div>
				  <svg
			...
			<div className="h-[190px] w-[22%] rounded-lg bg-green_dark1">
			  <div className="flex justify-between px-4 pb-4 pt-6">
				<div className="space-y-4">
				  ...
				  <div className="text-offwhite">
					<div className="text-[0.9rem]">Orders</div>
					<span className="text-[1.2rem] font-semibold">{orderVolume}</span>
				  </div>
				</div>
				<div>
				  <svg
