		...
		<div className="relative rounded-xl border p-2">
			...
			<div className="px-4 py-2">
				<div className="flex items-center space-x-2">
					<div className="rounded-full border border-redpink_light1 bg-redpink_light2 p-1">
						<svg
				...
				<div className="flex items-center space-x-2">
					<div className="flex items-center space-x-1 rounded-full bg-yellow_light1 px-3 py-1 text-yellow_dark1">
