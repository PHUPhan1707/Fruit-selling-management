...
const ASetting = () => {
    ...
    return (
        <div className="m-8 flex">
            ...
            {/* Body */}
            <div
                className={`${!showForm && !showPasswordForm ? 'block' : 'hidden'} mt-4 rounded-lg border border-grey_light1 px-12 py-2 w-[85%]`}
            >
                <div className="flex items-center space-x-4">
                    <img
                        src="/src/assets/userAvtG.jpg"
                        className="h-[12rem] w-[12rem] rounded-full border-4 border-green_dark1 shadow-lg"
                        alt=""
                    />
                    <div>
                        ...
                        <span className="text-green_dark1">Admin</span>
                    </div>
                </div>
