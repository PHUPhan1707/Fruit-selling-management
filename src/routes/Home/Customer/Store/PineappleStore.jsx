...
import ReviewPineapple from '../../../../components/Review/ReviewPineapple'

const PineappleStore = () => {
		...
		<div>
			...
			<div className="flex">
				<div className="ml-[55px]">
					<div
						className="mb-[10px] flex h-full w-full items-center justify-center"
