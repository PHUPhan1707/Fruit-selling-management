...
import topfruitmango from '../../../../assets/topfruitmango.png'
...
const TopFruitMango = () => {
	return (
		...
		>
			<img style={{ width: '392px', height: '240px' }} src={topfruitmango} />
			<div className="flex">
				<div
					style={{
						color: '#2C3721',
			...
			>
				Tropical fruits rich in fiber, antioxidants, vitamins A and C, and
				sweet, tangy flavor, mangoes make a wholesome and delightful snack.
			</div>
		</div>
	)
}

export default TopFruitMango
