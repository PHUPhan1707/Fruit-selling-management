...
import topfruitpapaya from '../../../../assets/topfruitpapaya.png'

const TopFruitPapaya = () => {
	return (
		<div
			style={{
				width: '392px',
		...
		>
			<img style={{ width: '392px', height: '240px' }} src={topfruitpapaya} />
			<div className="flex">
				<div
					style={{
						color: '#2C3721',
			...
			>
				Papayas are tropical fruits with orange flesh and black seeds. They are
				high in fiber, vitamins, and digestive enzymes, especially papain, which
