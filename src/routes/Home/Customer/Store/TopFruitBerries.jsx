...
import topfruitberries from '../../../../assets/topfruitberries.png'

const TopFruitBerries = () => {
	return (
		<div
			style={{
				width: '392px',
		...
		>
			<img style={{ width: '392px', height: '240px' }} src={topfruitberries} />
			<div className="flex">
				<div
					style={{
						color: '#2C3721',
			...
			>
				Berries, including strawberries, blueberries, raspberries,and
				blackberries, are small, colorful, and flavorful fruits with high
				antioxidant content, providing essential vitamins, fiber, and nutrients.
			</div>
		</div>
	)
}

export default TopFruitBerries
