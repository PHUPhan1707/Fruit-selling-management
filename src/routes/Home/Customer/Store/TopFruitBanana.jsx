...
import topfruitbanana from '../../../../assets/topfruitbanana.png'
...
const TopFruitBanana = () => {
	return (
		...
		>
			<img style={{ width: '392px', height: '240px' }} src={topfruitbanana} />
			<div className="flex">
				<div
					style={{
						color: '#2C3721',
			...
			>
				Popular tropical fruit, bananas are prized for their creamy texture and
				sweet taste. They offer you a rapid energy boost and are high in
