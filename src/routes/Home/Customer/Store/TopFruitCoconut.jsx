...
import topfruitcoconut from '../../../../assets/topfruitcoconut.png'

const TopFruitCoconut = () => {
	return (
		<div
			style={{
				width: '392px',
		...
		>
			<img style={{ width: '392px', height: '240px' }} src={topfruitcoconut} />
			<div className="flex">
				<div
					style={{
						color: '#2C3721',
			...
			>
				Coconuts, with their white flesh and firm shell, are a versatile fruit
				rich in vitamins, minerals, and electrolytes, offering health benefits
				like improved cholesterol and hydration.
			</div>
		</div>
	)
}

export default TopFruitCoconut
