...
const ErrorReport = ({ handleClose }) => {
	const [showThankYou, setShowThankYou] = useState(false)

	const handleYesPleaseCheckClick = () => {
	...
	return (
		<div>
			{showThankYou ? (
				...
				>
					<div style={{ width: 48, height: 48, margin: '0 0 0 0' }}>
						{/* SVG Image */}
						<svg
					...
					>
						Have you noticed a problem with this page and want to report an
						error?
					</div>
					<div
						style={{ margin: '10px 0 0 0' }}
						onClick={handleYesPleaseCheckClick}
					>
						<YesPleasecheck />
					</div>
				</div>
