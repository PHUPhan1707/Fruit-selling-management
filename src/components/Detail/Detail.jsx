			...
			>
				...
				>
					<div className="ml-[20px] mt-[21px]">
						...
						>
							<img className="m-auto" src={banana} alt="" />
						</div>
						<div
							className="mt-[25px]"
						...
						>
							...
							variety native to Hawaii's tropical rainforest region. Sweet,
							firm, and pink, they're perfect for snacking and desserts.
						</div>
					</div>
				...
				<div className="column-2 my-auto grid gap-[35px]">
					<AddToCart />
					<div onClick={onClose}>
						<Exit />
					</div>
